...
[![Build Status](https://github.com/conda-incubator/unidep/actions/workflows/pytest.yml/badge.svg)](https://github.com/conda-incubator/unidep/actions/workflows/pytest.yml)
[![CodeCov](https://codecov.io/gh/conda-incubator/unidep/branch/main/graph/badge.svg)](https://codecov.io/gh/conda-incubator/unidep)
[![GitHub Repo stars](https://img.shields.io/github/stars/conda-incubator/unidep)](https://github.com/conda-incubator/unidep)
...
<img src="https://raw.githubusercontent.com/conda-incubator/unidep/refs/heads/main/docs/source/logo.svg" alt="UniDep logo" align="right" width="240" />
...
<!-- echo '```bash' -->
<!-- echo '"${SHELL}"' '<(curl -LsSf raw.githubusercontent.com/conda-incubator/unidep/'"$HASH"'/bootstrap.sh)' -->
<!-- echo '```' -->
<!-- CODE:END -->
<!-- OUTPUT:START -->
...
```bash
usage: unidep [-h]
              {merge,install,install-all,conda-lock,pixi,pip-compile,pip,conda,doctor,version} ...
...
positional arguments:
  {merge,install,install-all,conda-lock,pixi,pip-compile,pip,conda,doctor,version}
    ...
    conda               Get the conda requirements for the current platform
                        only.
    doctor              Diagnose common Python and Conda environment issues.
...
It checks shell startup files, active environment variables, Homebrew Python inside Conda environments, and PATH shadowing.
...
including stacked environments, shell startup conflicts, Homebrew Python
inside Conda environments, and PATH shadowing.

options:
  -h, --help  show this help message and exit
  --json      Print machine-readable JSON instead of terminal-formatted text.
  --strict    Exit with status 1 when warnings are found.
```
...
**A:** Check out the [`example` folder](https://github.com/conda-incubator/unidep/tree/main/example).
...
In contrast, [UniDep](https://github.com/conda-incubator/unidep/) does not require Conda.
...
- No [logic operators in platform selectors](https://github.com/conda-incubator/unidep/issues/5) and [no Python selectors](https://github.com/conda-incubator/unidep/issues/7).
