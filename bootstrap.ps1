...
powershell -AcceptDefaults -ExecutionPolicy Bypass -Command "irm 'https://raw.githubusercontent.com/mamba-org/micromamba-releases/06b6b980f45b0bee0581a6a5b142a3bfd28e2481/install.ps1' | iex"
