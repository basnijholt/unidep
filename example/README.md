...
✅ Generated environment file at `environment.yaml` from `setup_py_project/requirements.yaml`, `setuptools_project/requirements.yaml`, `hatch_project/requirements.yaml`
```
...
📝 Found local dependencies: {'setup_py_project': ['setuptools_project', 'hatch_project']}

📦 Installing project with `/opt/hostedtoolcache/Python/3.12.0/x64/bin/python -m pip install -e /home/runner/work/unidep/unidep/example/setuptools_project -e /home/runner/work/unidep/unidep/example/hatch_project -e ./setup_py_project`
