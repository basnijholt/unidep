...
<!-- ⚠️ This content is auto-generated by `markdown-code-runner`. -->
```bash
📝 Found local dependencies: {'/home/runner/work/unidep/unidep/example/project1': {'/home/runner/work/unidep/unidep/example/project2', '/home/runner/work/unidep/unidep/example/project3'}}
...
📦 Installing local dependencies for project1: project2

📦 Installing project with `/opt/hostedtoolcache/Python/3.12.0/x64/bin/python -m pip install -e ./project2`

📦 Installing local dependencies for project1: project3

📦 Installing project with `/opt/hostedtoolcache/Python/3.12.0/x64/bin/python -m pip install -e ./project3`
